  ...
  while true; do
    ...
    case $op in
      1)
        ...
        print_success "Apache instalado y en ejecución."
...
EOF
        ...
        print_success "Monitoreo automático configurado para reiniciar servicios cada 5 min."
        read -p "Presione ENTER para continuar..." ;;
      ...
      4)
        ...
        for disk in $d1 $d2; do
          if [[ ! -b /dev/$disk ]]; then
            print_error "Disco /dev/$disk no válido."
            return
          fi
        done
